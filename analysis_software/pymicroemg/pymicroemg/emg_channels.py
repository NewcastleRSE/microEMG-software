...
class EMGChannels:
    ...
    def __init__(self, intan_chan_names: list[str] = None, n_chan: int = 0):
        """
        ...
        if intan_chan_names is None and n_chan == 0:
            raise Exception("To create an EMG channel (needle) model either a list of Intan channel names should be given or the number of channels.")
